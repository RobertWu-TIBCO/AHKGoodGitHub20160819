...
;我定义的快捷键
;=======================================================
;以下设置双击PageUp静音,change to others (Robert Wu@2016-07-10 10:41:38)
;$PGUP::
;$End::
$Home::
...
;comment to test include common.ahk
/*
...
*/
;==================================================================================
#include ..\Libs\ForCandy\Cando_有道翻译.ahk
#include ..\Libs\ForCandy\cando_msdn直达搜索_方便查看参数的值.ahk
#include ..\Libs\ForCandy\Cando_AHKCHM连查带搜.ahk
...
Cando_颜色查看:         ;（请注意Label的写法，是Cando_颜色查看，而不是“颜色查看”）
    ...
    Gui, Gui_SeeColor: Show, w200 h200,颜色查看
...
Gui_SeeColorGuiClose:

Gui_SeeColorguiescape:

    gui,Gui_SeeColor:Destroy
...
Cando_PathToClip:
clipboard := CandySel_ParentPath
return
;CandySel stands for the select or arg from ini file
;-------------------------------------------------------------------------------------
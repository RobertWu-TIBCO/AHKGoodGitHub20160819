...
;Menu, Tray, Icon,Database.ico
Menu, Tray, Icon,clipboard.ICO

/*
;comment loop for Lshift because it cause "`" and "|" unuseable in bash
~Lshift::
...
*/
#IfWinNotActive,ahk_exe cmd.exe|MultiDesk64.exe|bash.exe|sh.exe|cmder.exe|cmd.exe ;this helps to ensure ems in robert pc is not quit after double click of the mstsc title
~LButton::
MouseGetPos, xx
TimeButtonDown = %A_TickCount%
; Wait for it to be released
...
Loop
{
Hotkey,~MButton,PASTE,On UseErrorLevel
...
fail to use MButton for pasting contents 

PS:2160304 it works with middle button in the parent ahk file now !
*/

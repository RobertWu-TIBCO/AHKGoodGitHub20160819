...
::/tls1.2::
(
To use TLSv1.1 or TLSv1.2, customer should consider BW 5.11 or later.

  Please check LBN 43418 for BW 5.12 and LBN 43938 for BW 5.11  for more details as proper TRA hotfix are needed .
)
::/511tls::
(
Dear customer,
...
::/cases::E:\EasyOSLink\PCMasterMove\Downloads\Compressed\722195\TestCase
::/mime::
(
...
::zjk::人找车,现在从西二旗附近软件园二期文思海辉大厦走,回张家口桥东区张家口职业技术学院.一人 18519103730
::/now::人找车,现在从融泽嘉园一号院走,回张家口桥东区张家口职业技术学院.一人 18519103730, 13041204920
::zjkhome::人找车，今天下午4点以后从融泽嘉园一号院出发到张家口桥东区张家口职业技术学院，一个人，13041204920
::bj::人找车,;现在从张家口桥东区马路东街道 张家口职业技术学院(张家口桥东燕兴机械厂南边)走,回北京回龙观新村西二旗附近.一人 18519103730
;-------------------------------------------------------------------------------------
::bwservers::
(
...
::/migrate::
(
We understand that you are trying to migrate multiple projects from BW 5.x to 6.x and need help from Support in fixing these migration issues. We strongly recommend that you review LBN 41033 entitled, "What are the guidelines or recommendations for TIBCO ActiveMatrix BusinessWorks 6.x Adoption and Transition?" carefully before considering large scale migration.

Here are some important points from the LBN:

We recommend using BW 6.x for all new Enterprise Integration projects and use cases. We recommend that migration should only be done when there is a business ROI in migrating to BW 6.x. If you have large existing BW 5.x deployments, a hybrid environment with both BW 6.x and BW 5.x may be the best way to get started with BW 6.x adoption since it minimizes technology risk and maximizes return on investment.

BW 6.x provides a migration tool that helps convert certain BW 5.x project constructs to BW 6.x. Functionality provided by this tool continues to evolve and the level of migration automation that can be achieved varies based on the programming constructs used in the processes as well as the complexity of the BW 5.x projects.

There is some manual effort involved in migrating 5.x projects to BW 6.x and the effort involved depends on the complexity and the various constructs used in the 5.x project. TIBCO Support can help with issues where there is a demonstrable problem with the migrator utility, but we cannot execute the actual migration. Please refer to the BW documentation for more details on migration.

https://docs.tibco.com/pub/activematrix_businessworks/6.3.0/doc/html/GUID-15188D77-ADD7-47E1-B8B7-1A9A89DE53A9.html

If you need assistance with migration, contact your TIBCO Account Manager to discuss options involving TIBCO Professional Services for aiding in the migration.

http://10.106.148.71/ka/000/41033.htm

http://10.106.148.71/ka/000/45256.htm

https://docs.google.com/spreadsheets/d/18AsdE04cZjI3J2U4Jk5O_mfo85sC_g8rlJGPAUxppTc/edit#gid=0
)
;-------------------------------------------------------------------------------------
::invalidmailaddress::
(
BW-MAIL-100019 Job-24000 Error in [TcpTraceMail/SenderAttachSucceedTxtFilename_base64_PDF3_TcpTrace.process/Send Mail]
Error sending mail message. Cause: javax.mail.SendFailedException: Invalid Addresses;
nested exception is:
com.sun.mail.smtp.SMTPAddressFailedException: 550 User not found: 1wuyang19920118@163.com

)
::customfuncdoc::https://docs.tibco.com/pub/activematrix_businessworks/6.3.2/doc/html/GUID-13795D07-F63C-4B27-8A6B-9E620A74BB16.html
::/conflict::不知道为何 RunZ和自己写的脚本快捷键冲突呢? 后载入RunZ就可以用CapsLock & j 这样的快捷键, 后载入自己的脚本,就用不了此快捷键.
::ahkweb::http://zozhu.com/
::/133::13333136283
::/177::17717716048
::/qin::18612030083
::qin2::一个朋友也要来这边找个两居室,大家有没有好房子可以推荐的呀? 联系人: 秦先生,电话 18612030083 谢谢大家了！
;-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
::soaptarce::
(
Trace.Task.*=true

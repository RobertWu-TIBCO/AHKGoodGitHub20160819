...
AutoTrim,On
FileEncoding, CP936
;SendMode Input ;this seems made the hotstring doubled before
SetTitleMatchMode 2
SetWorkingDir %A_ScriptDir%
;hope runz supports c-f to go next page of possible commands, not just output

; 自动生成的待搜索文件列表
global g_SearchFileList := A_ScriptDir . "\Conf\SearchFileList.txt" ; found ser.bat there but it doesn't show up in runz gui since too many items and next page doesn't work
; 用户配置的待搜索文件列表
...
;------------------------------------------------------------------------------------- 
Hotkey, CapsLock & z, ClearInput ; ClearInput()
Hotkey, ^x,ClearInput
Hotkey, CapsLock & h, DisplayHistoryCommands
Hotkey, CapsLock & f, NextPage
Hotkey, CapsLock & b, DelAllBefore
Hotkey, CapsLock & /, DelAllAfter
Hotkey, CapsLock & j, NextCommand ; this works if RunZ started alone but fails if gmail ahk started then. they conflict ! If RunZ is run after gmail ahk then it works. Then gmail ahk hotkeys for notepad fails!
Hotkey, CapsLock & k, PrevCommand ;wonders if it works if I remove CapsLock key combinations from base ahk to gmail ahk
Hotkey, CapsLock & s, NextCommand
Hotkey, CapsLock & w, PrevCommand
;------------------------------------------------------------------------------------- 

Hotkey, Esc, EscFunction
Hotkey, CapsLock, EscFunction
;Hotkey, CapsLock, selfHide
Hotkey, !F4, ExitRunZ
...
Hotkey, ^l, ClearInput
Hotkey, LCtrl & BackSpace, ClearInput
...
#include %A_ScriptDir%\UserDefine\hotstring\May20.ahk
#include %A_ScriptDir%\UserDefine\hotstring\arrayini.ahk
;#include %A_ScriptDir%\UserDefine\menu\WinFastMenu.ahk
#include %A_ScriptDir%\Core\GlobalMenu.ahk
#include *i %A_ScriptDir%\Core\Plugins.ahk  ; misc(json) demo etc
; 发送到菜单自动生成的命令
...
/*
;THIS causes gmail CapsLock & w fail to work
;-------------------------------------------------------------------------------------
SetCapsLockState , AlwaysOff
LAlt & Capslock::SetCapsLockState, % GetKeyState("CapsLock", "T") ? "Off" : "On"
LCtrl & Capslock::SetCapsLockState, Off
Esc::CapsLock
...
:R:/ava::available
:R:tom::tommorow
:R:72238::192.168.72.238
:R:exclu::exclusive
:R:jmsq::JMS Queue Receiver
:R:consis::consistent
:R:163mail::wuyang19920118@163.com
...
:R:ibmsslv3::java.property.com.ibm.jsse2.disableSSLv3=false
:R:ibmsslv3error::IBMJSSE2 will not allow protocol SSLv3 per com.ibm.jsse2.disableSSLv3 set to TRUE or default
...
ControlGetPos, x, y, w, h, Button1,ahk_exe notepad++.exe ; this seems move the mouse to the left head of the screen because RegExMatch expression given before
...
;gosub winrun
gosub ReplaceSlashL
run,explorer %clipboard% ; has to do with the string format of slash "F:\tibco\bw\5.12" will fail. only able to use it WinRRun
return
;------------------------------------------------------------------------------------- 
...
downfile(tmp,"R:\UrlDownloadToFile.html") ; ud ip port . great! falils now ~
Run,"R:\UrlDownloadToFile.html"
}
...
downfile(tmp,"R:\UrlDownloadToFile.html") ; ud ip port . great! falils now ~
;downfile("http://192.168.69.124:9694","R:\UrlDownloadToFile.html") ;ok to save a http response to a html file. http or ftp protocol must be specified !
Run,"R:\UrlDownloadToFile.html"
Run,R:\
}
else

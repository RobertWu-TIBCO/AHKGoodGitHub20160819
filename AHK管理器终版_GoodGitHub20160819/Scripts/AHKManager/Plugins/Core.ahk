...
AhkTest:
    ...
    FileAppend, %text%`n, %A_Temp%\RunZ.AhkTest.ahk
    FileAppend, #include %A_ScriptDir%\Core\Common.ahk`n, %A_Temp%\RunZ.AhkTest.ahk  ; this causes the test ahk unable to run. so you could not use the funcs you have added. this is the only thing needs improved
	FileAppend, #include %A_ScriptDir%\Lib\JSON.ahk`n, %A_Temp%\RunZ.AhkTest.ahk 

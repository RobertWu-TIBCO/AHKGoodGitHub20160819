...
Demo:
    ...
    @("q", "checkInput")
    @("pans", "pan suffix")
    @("props", "BW property on confluence")
    @("qqdown", "qqdown")
    @("seat", "seat")
    @("mft2", "mft upload")
	...
	@("40","40")
	@("xtox","xmltoxsd")
	@("ftp","ftp server as services.msc")
	@("gitweb","gitweb")
	@("ecshort","ecshort eclipse short cut")
	@("attend","attend leave ")
	@("oldchina","oldchina ")
	@("gmailahk","gmail ahk search  ")
...
::sf::
run,https://tibcofullsso--tibcofull.cs41.my.salesforce.com/console
return

gmailahk:
EveSearch("gmail _simple ahk")
return

props:
run,http://confluence.tibco.com/display/BW/BW+and+BWSE+internal+and+external+properties+and+settings
;http://192.168.72.254:8080/display/bw/BWEngineProperties_Copy_From_Support_Wiki
return

ftp:
run,G:\SysManage\FirstSoft\FileZilla Server 0.9.41.0 emric绿色汉化精简版\FileZilla server.exe
return
xtox:
xmltoxsd:
run,http://www.freeformatter.com/xsd-generator.html#ad-output
return

oldchina:
run,http://www.webdog.cn/map/
return

gitweb:
run,https://github.com/RobertWu-TIBCO
return
...
mft2:
run,http://10.106.148.71/mft/uploads.jsp
return

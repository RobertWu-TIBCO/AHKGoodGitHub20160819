General:
	...
	vim.map("gg", "<home>", "General")
    vim.map("G", "<end>", "General")
    ...
    vim.map("cc", "<CloseWindow>", "General")
    vim.map("a", "<LeftTab>", "General")
    vim.map("d", "<RightTab>", "General")
    vim.map("w", "<wheelup2>", "General")
    vim.map("s", "<wheeldown2>", "General")
    vim.map("yy", "<dupLine>", "General")
    vim.map("yd", "<cutLine>", "General")
    vim.map("gj", "<LeftTab>", "General")
    vim.map("gk", "<RightTab>", "General")
    vim.map("gh", "<LeftTab>", "General")
    vim.map("gl", "<RightTab>", "General")

    vim.map("gf", "<Eve_GetSelected>", "General")
    vim.map("gp", "<Eve_GetPath>", "General")
	
    vim.map("[", "<NextTab>", "General")
    vim.map("]", "<PrevTab>", "General")
    vim.map("n", "<NextTab>", "General")
    vim.map("p", "<PrevTab>", "General")

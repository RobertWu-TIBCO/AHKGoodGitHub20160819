...
Explorer:
    ...
    vim.map("a", "<LeftTab>", "Explorer")
    vim.map("d", "<RightTab>", "Explorer")
	vim.map("w", "<wheelup2>", "Explorer")
    vim.map("s", "<wheeldown2>", "Explorer")
	
    vim.map("gf", "<Explorer_GetSelected>", "Explorer")
    vim.map("gp", "<Explorer_GetPath>", "Explorer")

/*
Filter=CustomFilter_FileType_Scite4AutoHotkey
Tips=此函数当所选仅包含Scite4AutoHotkey支持的文件时返回true
Author=LL
Version=0.1
*/

CustomFilter_FileType_Scite4AutoHotkey()
{	
    ExtNameSupported=ahk;scriptlet;ini;lua;properties

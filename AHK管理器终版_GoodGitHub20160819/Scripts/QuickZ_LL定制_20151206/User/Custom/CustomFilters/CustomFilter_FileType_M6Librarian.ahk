/*
Filter=CustomFilter_FileType_M6Librarian
Tips=此函数当所选仅包含M6Librarian支持的图标文件时返回true
Author=LL
Version=0.1
*/

CustomFilter_FileType_M6Librarian()
{	
    ExtNameSupported=icl;exe;dll;ocx;ico;cpl;

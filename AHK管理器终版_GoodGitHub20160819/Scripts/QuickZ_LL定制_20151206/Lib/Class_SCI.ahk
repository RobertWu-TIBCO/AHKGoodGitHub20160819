...
,SCLEX_OSCRIPT:=106,SCLEX_VISUALPROLOG:=107,SCLEX_LITERATEHASKELL:=108,SCLEX_AUTOMATIC=1000
}

; AHKL
{
global SCLEX_AHK1:=200,SCE_AHK_DEFAULT:=0,SCE_AHK_COMMENTLINE:=1,SCE_AHK_COMMENTBLOCK:=2,SCE_AHK_ESCAPE:=3,SCE_AHK_SYNOPERATOR:=4
,SCE_AHK_EXPOPERATOR:=5,SCE_AHK_STRING:=6,SCE_AHK_NUMBER:=7,SCE_AHK_IDENTIFIER:=8,SCE_AHK_VARREF:=9,SCE_AHK_LABEL:=10,SCE_AHK_WORD_CF:=11
,SCE_AHK_WORD_CMD:=12,SCE_AHK_WORD_FN:=13,SCE_AHK_WORD_DIR:=14,SCE_AHK_WORD_KB:=15,SCE_AHK_WORD_VAR:=16,SCE_AHK_WORD_SP:=17,SCE_AHK_WORD_UD:=18
,SCE_AHK_VARREFKW:=19,SCE_AHK_ERROR:=20
...
,SCLEX_AHK2:=201,SCE_AHK2_DEFAULT:=0,SCE_AHK2_COMMENTLINE:=1,SCE_AHK2_COMMENTBLOCK:=2,SCE_AHK2_ESCAPE:=3,SCE_AHK2_OPERATOR:=4,SCE_AHK2_STRING:=5
,SCE_AHK2_NUMBER:=6,SCE_AHK2_WORDOP:=7,SCE_AHK2_VAR:=8,SCE_AHK2_FUNC:=9,SCE_AHK2_DIRECTIVE:=10,SCE_AHK2_LABEL:=11,SCE_AHK2_FLOW:=12,SCE_AHK2_BIV:=13
,SCE_AHK2_BIF:=14,SCE_AHK2_ERROR:=15,SCE_AHK2_OBJPROP:=16,SCE_AHK2_OBJMETHOD:=17,SCE_AHK2_OBJPROP_BI:=18,SCE_AHK2_OBJMETHOD_BI:=19
   ...
   ; keywords6: Built-in Object Properties
   ; keywords7: Built-in Object Methods
}

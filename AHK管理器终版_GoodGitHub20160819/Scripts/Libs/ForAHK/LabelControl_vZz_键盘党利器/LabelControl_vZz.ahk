...
SetControlDelay,0
SetBatchLines,-1
Menu, Tray, Icon, F:\Program Files\AutoHotkey\Scripts\AHK管理器【终版】\Scripts\AHKManager\about.ico
...
Loop
{
  Sleep,10 ;change 0 to 10 so reduce cpu usage
  digit=z
  Loop,%linesSize%
  {
    Sleep,0
...
Gui,99:Add,Text,y+10,+ 自动单双字母键组合提示，取代原版数字的不便

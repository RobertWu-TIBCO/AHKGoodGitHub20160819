Cando_AHKCHM连查带搜:
  ...
  ;自定义部分
   ;Ahk帮助路径=F:\Program Files\AutoHotkey\Scripts\chm\AutoHotkey_cn_11.22.07.chm
   Ahk帮助路径=F:\Program Files\AutoHotkey\Scripts\chm\AutoHorkey-1.1.15.02.chm
   
  Ahk帮助标题=AutoHotkey 中文帮助
  ;Ahk帮助标题=AutoHotkey Help
